...
function maintenance_init(){
    ...
    if (! $CONFIG->walled_garden) {
        ...
        if (elgg_get_plugin_setting("maintenance_active","maintenance") == "yes"
            && !elgg_is_admin_logged_in()) {

            elgg_register_plugin_hook_handler('index','system','maintenance_index',0);
            ...
            if ($_SERVER["REQUEST_URI"] != $base_uri
                && $_SERVER["REQUEST_URI"] != "${base_uri}action/login") {
