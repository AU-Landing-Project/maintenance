<?php 
	...
	$form_body .= elgg_echo('username') . "</td><td>" . elgg_view('input/text', array('name' => 'username', 'class' => 'login-textarea')) . "</td><td>";
	$form_body .= "</td></tr><tr><td>";
	$form_body .= elgg_echo('password') . "</td><td>" . elgg_view('input/password', array('name' => 'password', 'class' => 'login-textarea')) . "</td><td>";
